        ...
        <div id="exercises-container">
            ...
            <div class="challenge-container">
                ...
                <p><strong>Objective:</strong><br>
                     Retrieve the credentials from the credspod pod and save them to a file named creds.txt in the /zencorp directory on the Kubernetes host. The pod name is credspod, it belongs to the zenspaceadv namespace, and the image used is specified as part of the challenge.</p>
