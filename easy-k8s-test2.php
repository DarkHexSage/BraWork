...
<body>
    <div class="container">
        ...
        <div id="shell-container">
            <iframe src="http://131.186.0.96:4801"></iframe>
        ...
        <div id="exercises-container">
            ...
            <!-- Challenge 2 -->
            <div class="challenge-container">
                <h3>Challenge 2:  Multi-Container Pod Deployment</h3>
                   <p><strong>Scenario:</strong><br>
    ...
    <script>
        ...
        function verifyChallenge(challengeNumber) {
            ...
            xhr.open("GET", "/verify-challengek8s-easyt" + challengeNumber + ".php", true);
            xhr.send();
        }
