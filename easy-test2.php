...
<body>
    <div class="container">
        ...
        <div id="exercises-container">
            ...
            <ul>
                <h4>Welcome to the Linux Testcenter Challenge: EASY 2</h4>
                <strong>Username:</strong> candidate <br>
                <strong>Password:</strong> candidate123 <br>
                <strong><h3>Needle in a haystack</h3></strong>


     <li><strong>Challenge 1:</strong>  Count the number of files in folder <strong>/challenge/howmany/ </strong> write down the number digit within file <strong>/challenge/quantity.txt</strong>. <br>
        <button id="challenge1Button" class="challenge-button" onclick="verifyChallenge(1)">Verify Challenge 1</button><br><br>

        <li><strong>Challenge 2:</strong>  Concatenate the contents of all .txt files within the <strong>/challenge/conc/</strong> directory into a single file named <strong>concatenated_files.txt</strong> save it at <strong>/challenge/</strong>.</li>
 ...
 <br>              <strong> Wishing you the best of luck on your Linux adventure!</strong>
    ...
    <script>
        ...
        function verifyChallenge(challengeNumber) {
            ...
            xhr.open("GET", "/verify-challenge-easyt" + challengeNumber + ".php", true);
            xhr.send();
        }
