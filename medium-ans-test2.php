...
<body>
    <div class="container">
        ...
        <div id="exercises-container">
            <h1>Ansible Exercises Medium 2</h1>
            <div id="timer">30:00</div> <!-- Timer added here -->
            <div class="challenge">
                           <!-- Challenge 1 -->
            <div class="challenge-container">
                <h3>Challenge 1: Modify a file</h3>
	...
	You have a file named /challenge/config.txt</p>
            ...
            <!-- Challenge 2 -->
            <div class="challenge-container">
                <h3>Challenge 2: Install a Python Package</h3>
     <p><strong>Scenario:</strong><br>
    ...
    <script>
        ...
        function verifyChallenge(challengeNumber) {
            ...
            xhr.open("GET", "/verify-challengeans-medt" + challengeNumber + ".php", true);
            xhr.send();
        }
